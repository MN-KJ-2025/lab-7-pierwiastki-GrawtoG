...
valid_is_nonsingular = [
    (A, res) for A, res in expected["is_nonsingular"] if res is not None
]
invalid_is_nonsingular = [
    (A, res) for A, res in expected["is_nonsingular"] if res is None
]
